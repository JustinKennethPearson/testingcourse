...
Ariane 4 and people forgot that Ariane 5 had higher initial
acceleration.  
\end{frame}
...
\begin{frame}
  ...
  \item These are just some of more spectacular examples. There is
    lots and lot of bad software out there. Anything we can do to
...
\begin{frame}
  ...
  \item The book {\em Test-Driven Development by Example} by Kent Beck.
    ...
    extreme programming. 
  \item {\em Practical software testing} by Ilene Burnstein. This is
    really the recommened testing book for this course.
  \end{itemize}
\end{frame}
\begin{frame}
